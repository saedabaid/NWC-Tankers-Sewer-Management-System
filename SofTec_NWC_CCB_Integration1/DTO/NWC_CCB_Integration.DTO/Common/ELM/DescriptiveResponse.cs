...
namespace NWC_CCB_Integration.DTO.Common.ELM
{
    ...
    public class DescriptiveResponse<T> : DescriptiveObject
    {
        ...
        [OperationContract]
        public static DescriptiveResponse<T> Success(string customDescription, T value, DateTime dt)
        {
            var res = new DescriptiveResponse<T>();
            return new DescriptiveResponse<T>
            {
        ...
        [OperationContract]
        public static new DescriptiveResponse<T> Error(string status, string customDescription, ErrorStatus metadata = ErrorStatus.CUSTOM)
        {
            return new DescriptiveResponse<T>
            {
                Status = status,
