...
export declare class SliderComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private findStepIndex(modelValue);
    ...
    private onBarStart(draggableRange, pointer, event);
    private onBarMove(draggableRange, pointer, event);
    private onStart(pointer, ref, event);
    private onMove(pointer, event, fromTick?);
    private onEnd(event);
    private onTickClick(pointer, event);
