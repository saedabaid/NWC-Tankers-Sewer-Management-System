(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('ng5-slider', ['exports', '@angular/core', '@angular/common'], factory) :
	(factory((global['ng5-slider'] = {}),global.ng.core,global.ng.common));
...
var ValuePositionConverter = (function () {
    function ValuePositionConverter() {
    }
    ValuePositionConverter.linearValueToPosition = function (val, minVal, maxVal) {
        var range = maxVal - minVal;
        return (val - minVal) / range;
    };
    ValuePositionConverter.logValueToPosition = function (val, minVal, maxVal) {
        val = Math.log(val);
    ...
    ValuePositionConverter.linearPositionToValue = function (percent, minVal, maxVal) {
        return percent * (maxVal - minVal) + minVal;
    };
    ValuePositionConverter.logPositionToValue = function (percent, minVal, maxVal) {
        minVal = Math.log(minVal);
        maxVal = Math.log(maxVal);
        var value = percent * (maxVal - minVal) + minVal;
        return Math.exp(value);
    };
    return ValuePositionConverter;
}());
var JqLiteWrapper = (function () {
...
var RightOutSelDirective = (function (_super) {
...
var LeftOutSelDirective = (function (_super) {
...
var FullBarDirective = (function (_super) {
...
var SelBarDirective = (function (_super) {
...
var MinHDirective = (function (_super) {
...
var MaxHDirective = (function (_super) {
...
var FlrLabDirective = (function (_super) {
...
var CeilLabDirective = (function (_super) {
...
var MinLabDirective = (function (_super) {
...
var MaxLabDirective = (function (_super) {
...
var CmbLabDirective = (function (_super) {
...
var TicksDirective = (function (_super) {
...
var SliderComponent = (function () {
    ...
    SliderComponent.prototype.findStepIndex = function (modelValue) {
        var index = 0;
        for (var i = 0; i < this.viewOptions.stepsArray.length; i++) {
            var step = this.viewOptions.stepsArray[i];
    ...
    SliderComponent.prototype.roundStep = function (value, customStep) {
        ...
        var steppedDifference = +((value - this.minValue) / step).toPrecision(12);
    ...
    SliderComponent.prototype.valueToPosition = function (val) {
        var fn = ValuePositionConverter.linearValueToPosition;
    ...
    SliderComponent.prototype.positionToValue = function (position) {
        ...
        var fn = ValuePositionConverter.linearPositionToValue;
    ...
    SliderComponent.prototype.bindEvents = function () {
        ...
        if (!this.viewOptions.onlyBindHandles) {
            this.selBarElem.on('mousedown', function (event) { return _this.onBarStart(draggableRange, null, event); });
            this.selBarElem.on('mousedown', function (event) { return _this.onBarMove(draggableRange, _this.selBarElem, event); });
        }
        if (this.viewOptions.draggableRangeOnly) {
            this.minHElem.on('mousedown', function (event) { return _this.onBarStart(draggableRange, null, event); });
            this.maxHElem.on('mousedown', function (event) { return _this.onBarStart(draggableRange, null, event); });
        }
        else {
            this.minHElem.on('mousedown', function (event) { return _this.onStart(_this.minHElem, HandleType.Low, event); });
            if (this.range) {
                this.maxHElem.on('mousedown', function (event) { return _this.onStart(_this.maxHElem, HandleType.High, event); });
            }
            if (!this.viewOptions.onlyBindHandles) {
                this.fullBarElem.on('mousedown', function (event) { return _this.onStart(null, null, event); });
                this.fullBarElem.on('mousedown', function (event) { return _this.onMove(_this.fullBarElem, event); });
                this.ticksElem.on('mousedown', function (event) { return _this.onStart(null, null, event); });
                this.ticksElem.on('mousedown', function (event) { return _this.onTickClick(_this.ticksElem, event); });
            }
        }
        if (!this.viewOptions.onlyBindHandles) {
            this.selBarElem.on('touchstart', function (event) { return _this.onBarStart(draggableRange, null, event); });
            this.selBarElem.on('touchstart', function (event) { return _this.onBarMove(draggableRange, _this.selBarElem, event); });
        }
        if (this.viewOptions.draggableRangeOnly) {
            this.minHElem.on('touchstart', function (event) { return _this.onBarStart(draggableRange, null, event); });
            this.maxHElem.on('touchstart', function (event) { return _this.onBarStart(draggableRange, null, event); });
        }
        else {
            this.minHElem.on('touchstart', function (event) { return _this.onStart(_this.minHElem, HandleType.Low, event); });
            if (this.range) {
                this.maxHElem.on('touchstart', function (event) { return _this.onStart(_this.maxHElem, HandleType.High, event); });
            }
            if (!this.viewOptions.onlyBindHandles) {
                this.fullBarElem.on('touchstart', function (event) { return _this.onStart(null, null, event); });
                this.fullBarElem.on('touchstart', function (event) { return _this.onMove(_this.fullBarElem, event); });
                this.ticksElem.on('touchstart', function (event) { return _this.onStart(null, null, event); });
                this.ticksElem.on('touchstart', function (event) { return _this.onTickClick(_this.ticksElem, event); });
            }
        }
        if (this.viewOptions.keyboardSupport) {
    ...
    SliderComponent.prototype.onBarStart = function (draggableRange, pointer, event) {
        if (draggableRange) {
    ...
    SliderComponent.prototype.onBarMove = function (draggableRange, pointer, event) {
        if (draggableRange) {
    ...
    SliderComponent.prototype.onStart = function (pointer, ref, event) {
        var _this = this;
        var moveEvent = '';
        var endEvent = '';
    ...
    SliderComponent.prototype.onTickClick = function (pointer, event) {
    ...
    SliderComponent.prototype.onDragStart = function (pointer, ref, event) {
        var position = this.getEventPosition(event);
        this.dragging = new Dragging();
...
var TooltipWrapperComponent = (function () {
