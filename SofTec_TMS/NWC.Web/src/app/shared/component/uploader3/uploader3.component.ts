...
@Component({
  selector: 'uploud-files3',
  templateUrl: './uploader3.component.html',
  styleUrls: ['./uploader3.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class UploudFilesComponent3 implements OnInit {
  extensions: string[];
  ...
  @ViewChild('fileUpload3', { static: true }) myFileControl: ElementRef;
