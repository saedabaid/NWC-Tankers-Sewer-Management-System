...
@Component({
  selector: 'uploud-files2',
  templateUrl: './uploader2.component.html',
  styleUrls: ['./uploader2.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class UploudFilesComponent2 implements OnInit {
  extensions: string[];
  ...
  @ViewChild('fileUpload2', { static: true }) myFileControl: ElementRef;
