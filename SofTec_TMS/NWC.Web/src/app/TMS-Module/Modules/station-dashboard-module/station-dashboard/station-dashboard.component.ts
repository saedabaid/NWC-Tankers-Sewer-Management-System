...
export class StationDashboardComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.pagePermission = this.authenticationService.getCurrentUserPermissionByRoleName("stationDashboard");
  ...
  load() {
    ...
    this.titleService.setTitle(this.translateService.instant("FSManagerDashboard"));
  }
  ngOnDestroy(): void {
