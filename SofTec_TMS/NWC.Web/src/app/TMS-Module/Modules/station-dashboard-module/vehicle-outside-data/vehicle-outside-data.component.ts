...
@Component({
  selector: 'vehicle-outside-data',
  templateUrl: './vehicle-outside-data.component.html',
  styleUrls: ['./vehicle-outside-data.component.scss']
})
export class VehicleOutsideDataComponent implements OnInit {
