...
@Component({
  selector: "app-new-edit-permit-list",
  templateUrl: "./new-edit-permit-list.component.html",
  styleUrls: ["./new-edit-permit-list.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class NewEditPermitListComponent implements OnInit {
