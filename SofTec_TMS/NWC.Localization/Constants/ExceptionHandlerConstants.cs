...
namespace NWC.Localization.Constants
{
    public static class ExceptionHandlerConstants
    {
        ...
        public static string InformationLogTextFilePathKey = "InformationLogTextFilePathKey";
        public static string LogsPathKey = "LogsPath";
    }
}
